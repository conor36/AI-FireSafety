...
color_dict = {7:"yellow", 6:"orange", 5:"red", 4: "red", 3: "green", 2: "pink", 1: "black", 0: "white"}
...
def fire_main(canvas, maze, fire_node, col_len, row_len, root):
...
def a_star_main(canvas, maze, start_node, exit_node, col_len, row_len, root):
    ...
    start_node.g = 0
    exit_node.wall = 7 # green in the color dict
    start_node.wall = 5
